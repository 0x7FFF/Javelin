...
public class ButtonsViewHolderFactoryChain implements ViewHolderFactoryChain<ItemUi> {

    private final ViewHolderFactoryChain<ItemUi> viewHolderFactoryChain;

    public ButtonsViewHolderFactoryChain(ViewHolderFactoryChain<ItemUi> viewHolderFactoryChain) {
